...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Práctica 3 Elizalde Pérez Alan", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, 0.5f, glm::vec3(0.0f, -0.5f, 2.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, 0.50f, glm::vec3(0.80f, -1.0f, 2.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		//Cubo 3
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.4f, -1.8f, 0.5f));
		model = glm::rotate(model, 0.50f, glm::vec3(0.0f, -0.5f, 1.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		//Cubo 4
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.4f, -1.8f, 0.5f));
		model = glm::rotate(model, 0.50f, glm::vec3(0.0f, -0.5f, 2.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
